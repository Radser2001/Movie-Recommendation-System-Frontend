  ...
  return (
    <div className="fixed top-0 left-0 right-0 bottom-0 flex items-center justify-center bg-black bg-opacity-70 z-10">
      <div className="bg-white p-6 rounded-md">
        ...
        <div className="flex mt-6 mb-4 flex-row items-center justify-around">
          <button
            onClick={onContinue}
          ...
          <button
            ...
            className="bg-red-600 py-3 ml-4 text-white rounded-md w-full mt-6 hover:bg-red-700 transition"
          >
            Submit
          </button>
        </div>
